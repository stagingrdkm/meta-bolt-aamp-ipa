...
SRCREV = "141aee7d548dd5dd4fbe66a753d0625f6ea766a9"

CMF_GIT_ROOT ?= "git://code.rdkcentral.com/r"
CMF_GIT_PROTOCOL ?= "https"
SRC_URI ="${CMF_GIT_ROOT}/components/opensource/rpcserver;name=rpcserver;protocol=${CMF_GIT_PROTOCOL};branch=master"
